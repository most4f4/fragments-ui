        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.amazoncognito.com https://*.auth.us-east-1.amazoncognito.com https://cognito-idp.us-east-1.amazonaws.com blob:",
